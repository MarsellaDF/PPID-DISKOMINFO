    ...
    <!-- <div class="container-xxl py-5">
        ...
        <div class="container">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s" style="max-width: 600px;">
                    ...
                    <p><i class="text-primary me-3"></i>A1. SOP PERMOHONAN INFORMASI PUBLIK</p>
                    <img class="img-fluid rounded w-500 align-self-end" src="/assets/template/img/a1.jpeg" >
                    ...
                    <p><i class="text-primary me-3"></i>A2. SOP PERMOHONAN INFORMASI PUBLIK</p>
                    <img class="img-fluid rounded w-500 align-self-end" src="/assets/template/img/a22.jpeg" alt="">
                    ...
                    <p>c. Pejabat Pengelola Informasi dan Dokumentasi mampu memberikan pelayanian informasi secara cepat dan tepat waktu dengan biaya ringan dan cara sederhana.</p> -->
                    <p><i class="text-primary me-3"></i>B1. SOP PERMOHONAN INFORMASI PUBLIK</p>
                    <img class="img-fluid rounded w-500 align-self-end" src="/assets/template/img/b1.jpeg" alt="">
                    <p><i class="text-primary me-3"></i>B2. SOP PERMOHONAN INFORMASI PUBLIK</p>
                    <img class="img-fluid rounded w-500 align-self-end" src="/assets/template/img/b22.jpeg" alt="">
                </div>
            </div>
        </div>
    </div>
