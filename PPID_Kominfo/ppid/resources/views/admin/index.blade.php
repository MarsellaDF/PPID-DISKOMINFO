                                ...
                                <span class="nav-user-img">
                                    <picture>
                                        <source srcset="/assets/auth/img/avatar/avatar-illustrated-02.webp"
                                            type="image/webp"><img
                                            src="/assets/auth/img/avatar/avatar-illustrated-02.png" alt="User name">
                                    </picture>
                                </span>
                            </button>
                                        ...
                                        <tr>
                                            <td>
                                                <label class="users-table__checkbox">
                                                    ...
                                                    <div class="categories-table-img">
                                                        <picture>
                                                            <source srcset="/assets/auth/img/categories/01.webp"
                                                                type="image/webp"><img
                                                                src="/assets/auth/img/categories/01.jpg"
                                                                alt="category">
                                                        </picture>
                                                    </div>
                                                </label>
                                            ...
                                            <td>
                                                <div class="pages-table-img">
                                                    <picture>
                                                        <source srcset="/assets/auth/img/avatar/avatar-face-04.webp"
                                                            type="image/webp"><img
                                                            src="/assets/auth/img/avatar/avatar-face-04.png"
                                                            alt="User Name">
                                                    </picture>
                                                    Jenny Wilson
                                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <label class="users-table__checkbox">
                                                    ...
                                                    <div class="categories-table-img">
                                                        <picture>
                                                            <source srcset="/assets/auth/img/categories/02.webp"
                                                                type="image/webp"><img
                                                                src="/assets/auth/img/categories/02.jpg"
                                                                alt="category">
                                                        </picture>
                                                    </div>
                                                </label>
                                                ...
                                                <div class="pages-table-img">
                                                    <picture>
                                                        <source srcset="/assets/auth/img/avatar/avatar-face-03.webp"
                                                            type="image/webp"><img
                                                            src="/assets/auth/img/avatar/avatar-face-03.png"
                                                            alt="User Name">
                                                    </picture>
                                                    Annette Black
                                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <label class="users-table__checkbox">
                                                    ...
                                                    <div class="categories-table-img">
                                                        <picture>
                                                            <source srcset="/assets/auth/img/categories/03.webp"
                                                                type="image/webp"><img
                                                                src="/assets/auth/img/categories/03.jpg"
                                                                alt="category">
                                                        </picture>
                                                    </div>
                                                </label>
                                                ...
                                                <div class="pages-table-img">
                                                    <picture>
                                                        <source srcset="/assets/auth/img/avatar/avatar-face-02.webp"
                                                            type="image/webp"><img
                                                            src="/assets/auth/img/avatar/avatar-face-02.png"
                                                            alt="User Name">
                                                    </picture>
                                                    Kathryn Murphy
                                                </div>
                                        ...
                                        <tr>
                                            <td>
                                                <label class="users-table__checkbox">
                                                    ...
                                                    <div class="categories-table-img">
                                                        <picture>
                                                            <source srcset="/assets/auth/img/categories/04.webp"
                                                                type="image/webp"><img
                                                                src="/assets/auth/img/categories/04.jpg"
                                                                alt="category">
                                                        </picture>
                                                    </div>
                                                </label>
                                                ...
                                                <div class="pages-table-img">
                                                    <picture>
                                                        <source srcset="/assets/auth/img/avatar/avatar-face-05.webp"
                                                            type="image/webp"><img
                                                            src="/assets/auth/img/avatar/avatar-face-05.png"
                                                            alt="User Name">
                                                    </picture>
                                                    Guy Hawkins
                                                </div>
