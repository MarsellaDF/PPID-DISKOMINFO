...
@section('content')
    ...
    <div class="container" style="padding: 24px; background-color:white">
        <form method="post" action="{{ url('adminberkala-admin')}}" enctype="multipart/form-data">
            @csrf
            <div class="body">
                <div class="row">
                    <div class="col-lg-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="title" class="form-control" placeholder="Inputkan Judul Informasi Berkala"/>
                            </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="form-group">
