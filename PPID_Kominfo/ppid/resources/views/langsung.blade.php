         <div class="container-xxl py-5">
            <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s">
             ...
             1. Pemohon informasi datang ke tempat layanan informasi mengisi formulir permintaan informasi dengan melampirkan foto copy KTP pemohon dan pengguna informasi, bagi lembaga dilengkapi foto copy akta pendirian, surat keterangan terdaftar di Kominfo Kabupatem Banyuwangi.<br>
             ...
             4. Petugas memproses permintaan pemohon informasi publik sesuai dengan formulir permintaan informasi publik yang telah ditandatangani oleh pemohon informasi publik.<br>
             5. Petugas menyerahkan informasi sesuai dengan yang diminta oleh pemohon/pengguna informasi. Jika informasi yang diminta masuk dalam kategori dikecualikan, PPID menyampaikan alasan sesuai dengan keterangan perundangan yang berlaku.<br>
             ...
             7. Membukukan dan mencatat.
                    <h1 class="mb-4"> JANGKA WAKTU PENYELESAIAN </h1>
             </div>
