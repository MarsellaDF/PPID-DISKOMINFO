...
<div class="container-xxl py-5" href="/langsung">
    ...
    1. Pemohon informasi datang ke tempat layanan informasi mengisi formulir permintaan informasi dengan melampirkan
    ...
    1. Proses penyelesaian untuk memenuhi permintaan pemohon informasi publik dilakukan setelah pemohon informasi
    ...
    informasi ditolak, maka dalam surat pemberitahuan dicantumkan alasan penolakan.<br>
    <div class="text-center mx-auto mb-5 wow fadeInUp" data-wow-delay="0.1s">
...
<div class="container-xxl py-5" href="/assets/template/img/Alur permohonan informasi.png">
    <div class="text-center mx-auto mb-5">
        ...
        <img class="img-fluid rounded w-500 align-self-end"
            src="/assets/template/img/Alur permohonan informasi.png"><br>
    </div>
</div>
